...
function _joinOneParticularAssoc (options, cb) {
  ...
  // Note:
  // This entire step may be optionally overridden by passing in a function
  // for `options.$populateBuffers`.
  $populateBuffers = options.$populateBuffers || function fetchRelevantChildRecords(options, _onwards) {
